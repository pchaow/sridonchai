...
import { Button, Card, CardBody, Tabs, Tab, Navbar, NavbarContent, NavbarItem, Table, TableHeader, TableColumn, TableBody, TableRow, TableCell } from "@nextui-org/react";
import { IoArrowBack } from "react-icons/io5";
import { useNavigate, useParams } from "react-router-dom";
import { FaCamera ,FaPen ,FaMoneyBill } from "react-icons/fa6";
...
export default function CustomerView() {
    ...
    const customer_card = (customer: any) => {
        if (customer) {
            return (
                <Card className="m-0 background-primary" isPressable key={customer.name} onClick={() => { navigate(`/home/view/${customer.name}`) }}>
                    <CardBody>
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-col mx-6 my-0 gap-3">
                ...
                <Button  color="success" startContent={<FaPen />}>
                    บันทึกมาตรน้ำ
                </Button>
